...
const SearchPage = ({ rating }) => {
  ...
  const handleClick = (btnIndex) => {
    ...
    const numClicked = Object.values({ ...toggle, [btnIndex]: !toggle[btnIndex] }).filter((val) => val).length;
  ...
  const extraContent = <p className="extra-content">
          ...
          <Navbar.Collapse id="navbarScroll" >
            ...
            >
              ...
              <div className='d-flex ml-auto p-2 '>
                ...
                <NavDropdown className='border border-2 border-dark rounded-2 ms-3 ' title="GİRİŞ YAP" id="navbarScrollingDropdown">
                  <NavDropdown.Item href="#action3">Action</NavDropdown.Item>
                  <NavDropdown.Item href="#action4">
                    Another action
                  </NavDropdown.Item>
        ...
        <div className=''>
          {
            lawyers.map((user, index) => {
              ...
              return (
                <div className=' d-flex justfiy-content-around m-5 '>
                  ...
                  <div className='border border-warning flex-fill m-2 p-2 rounded-4 '>
                    <div className='d-flex '>
                      <div className='w-75'>
                        <div className="d-flex w-100 ">
                          ...
                          <div className='dflex flex-fill m-2 '>
                            <div className="flex-grow-1 mx-2 ">
                              ...
                              <i class="fa-solid fa-clipboard-check mx-2 text-warning">

                              </i>
                            </div>
                            <div className='d-flex'>
                              <div className='mx-2 text-success'> <i className="fa-solid fa-circle-check"></i> <span>online görüşmeye uygun</span>  </div>
                        ...
                        <div className='mt-2 '>
                          <p> Adres: dad adsad adasd asdasd asdasd asd asd d
                          </p>
                          <h5 className="star">Bio</h5>
                          <p className='extra-content'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui, consectetur nequeab porro quasi culpa nulla rerum quis minus voluptatibus sed hic ad quo sint, libero commodi officia aliquam! Maxime. Lorem ipsum dolor sit amet consectetur adipisicing elit.  </p>
