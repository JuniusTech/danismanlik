          ...
          <Navbar.Collapse id="navbarScroll">
            ...
            >
              ...
              <div className="d-flex justify-content-center">
                <select className='border-0 m-1' value={branch} name="branch" onChange={handleInput} title="Branş Seç" id="navbarScrollingDropdown">
                ...
                <Form onSubmit={handleSubmit} className="search-form ">
                  ...
                  />
                  <button type='submit' variant='outline-warning' className='b text-light search-inputbutton' >Avukat Ara</button>
                </Form>
              </div>
