      ...
      >
        ...
        <div style={{ color: "#00242E" }}>
          ...
          >
            ...
            Müşterilerinizin yapılan yorumlar ve değerlendirmeler ile sizi daha
            hızlı tercih etmesini sağlayın.
          </p>
          <button
            style={{
              height: "78.86px",
      ...
      >
        <div style={{ color: "#00242E", padding: "40px 100px 0 40px" }}>
          ...
          >
            ...
            belirlediğiniz saat aralığında, müsait zamanlarınızda görüşme talebi
            oluşturmasını sağlayın, hızlı bir şekilde iletişime geçin.
          </p>
          <button
            style={{
              height: "78.86px",
