    ...
    return (
        <div className='lawyerdashboard-datedetail'>
            ...
            <div style={{ width: "258px", marginLeft: "20px", marginRight: "25px" }}>
                <p style={{ borderBottom: "1px solid #a97900", paddingBottom: "5px", fontSize: "14px", fontWeight: "bold" }}> Müvekkil Adı: Onur KILIÇ </p>
                <p style={{ borderBottom: "1px solid #a97900", paddingBottom: "5px", fontSize: "14px", fontWeight: "bold" }}> Randevu Konusu: İcra Takibi </p>
                <p style={{ borderBottom: "1px solid #a97900", paddingBottom: "5px", fontSize: "14px", fontWeight: "bold" }}> Randevu Tarihi: 28 Mart 2023 </p>
                <p style={{ borderBottom: "1px solid #a97900", paddingBottom: "5px", fontSize: "14px", fontWeight: "bold" }}> Randevu Saati: 11:00 </p>
                ...
                <p style={{ borderBottom: "1px solid #a97900", paddingBottom: "5px", fontSize: "14px", fontWeight: "bold" }}> Referans No: 67FGQRT123E </p>
