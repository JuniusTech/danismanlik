    ...
    return (
        <div className='lawyerdashboard-datedetail'>
            ...
            <div style={{ width: "258px", marginLeft: "20px", marginRight: "25px" }}>
                ...
                <p style={{ borderBottom: "1px solid #a97900", paddingBottom: "5px", fontSize: "14px", fontWeight: "bold" }}> Referans Durumu:
                    {date.status === 'planned' && (
                        <button
                            style={{
            ...
            <p style={{ color: "#a97900", textAlign: "center", fontWeight: "bold", marginLeft: "5px", marginTop: "28px", backgroundColor: "transparent", border: "none", cursor: "pointer" }}
