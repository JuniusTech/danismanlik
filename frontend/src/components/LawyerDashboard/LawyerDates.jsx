...
const LawyerDates = ({ handleDateClick, index }) => {
    ...
    return (
        <div style={{ padding: "20px", color: " #00242E" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", height: "640px" }}>
                <div>
                ...
                <div
                    style={{ marginTop: "10px", display: "flex", justifyContent: "end", alignItems: "flex-end" }}
                >
