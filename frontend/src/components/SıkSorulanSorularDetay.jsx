    ...
    <div>
      ...
      >
        ...
        >
          ...
          >
            <p
              style={{ fontSize: "24px", fontWeight: "500", color: "#A97900" }}
            >
          ...
          >
            <p style={{ fontSize: "36px", fontWeight: "300", width: "650px" }}>
              Hesabımı silersem aynı hesabı daha sonra yeniden açabilir miyim?
            </p>
            <p
              style={{
            ...
            >
              Verilerinizin güvenliğine ilişkin Aydınlatma Metni'miz kapsamında
              silinen bir hesaba daha sonra yeniden ulaşamazsın. Sadece bir
              süreliğine Avukatımol'u kullanmaya ara vermeyi planlıyorsan
              hesabını dondurabilirsin. Böylelikle dilediğin zaman hesabını aynı
              giriş bilgilerinle tekrar aktifleştirebilir, Avukatımol'u
              kullanmaya devam edebilirsin. Ancak daha önce sildiğin bir hesabın
              varsa ne yazık ki hesabını tekrar kullanabilmen mümkün değil.
            </p>
            <p
              style={{
                position: "absolute",
